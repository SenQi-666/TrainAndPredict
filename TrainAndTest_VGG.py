...
files, labels, clazz, average = CountFiles(r"train")
...
modelCheckpoint = ModelCheckpoint(filepath="./vggmodel_{epoch:02d}-{val_loss:.2f}-{val_acc:.2f}.hdf5", verbose=0,
                                  save_best_only=True)
print(
    "\nclass num : {}, pic average: {}, train num: {}, test num: {}, batch : {}, train steps: {}, validation steps : {}".format(
        clazz, average, len(train_x), len(test_x), batch, steps_per_epoch, validation_steps))
model.fit_generator(
